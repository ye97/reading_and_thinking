...
![jupyter notebook](jupyter/13714448-24964dfe5bf967db.png)
...
![jupyter notebook代码分块运行、嵌入Markdown文档和图片](jupyter/13714448-2443a11c336e5dcb.png)
...
![ipython](jupyter/13714448-a2490a2882107148.png)
...
![jupyter notebook打开界面](jupyter/13714448-803f32720cf0278e.png)
...
![勾选文件夹，点击rename重命名](jupyter/13714448-8919418efb809f54.png)
...
![重命名](jupyter/13714448-13476809ac9b10e3.png)

在代码框中输入第一行python代码，shift+回车运行

![输入第一行python代码](jupyter/13714448-540050c6c6fd06ba.png)

![运行第一行python代码](jupyter/13714448-6be52bc326129244.png)
...
Jupyter notebook中，有两种单元格：<strong style="color:red;">代码单元格和Markdown单元格</strong>。
...
![编辑Markdown单元格](jupyter/13714448-7bf02cfeab7ecf42.png)

然后按`shift`+`Enter`运行该单元格。

![Markdown渲染效果](jupyter/13714448-6ff0bf8ba88c6b6c.png)
...
![命令模式快捷键](jupyter/13714448-b9df2500cb80d59c.png)

![编辑模式快捷键](jupyter/13714448-62d750fe7af8823e.png)
...
![在Markdown单元格中输入Latex公式](jupyter/13714448-0bbb7722aef50550.png)

按`shift`+`Enter`渲染运行：

![渲染之后的Latex数学公式](jupyter/13714448-7fa655030c9da5ec.png)

# 数据分析与可视化实战案例：学习时间与成绩的关系（线性回归）

先用excel把玩数据

![excel中的线性回归](jupyter/13714448-8aeb063599a395b6.png)
...
markdown则没有快捷键，需要自己记忆如何输入各种格式

[打开markdown语法](./markdown.md)
